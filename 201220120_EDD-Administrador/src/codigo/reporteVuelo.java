 ...
 * @author Braian
 */
public class reporteVuelo extends javax.swing.JFrame {
    ...
    public void datosVentana() {
        ...
        panelGrapviz.setContentType("text/html");
        try {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Grafica - Grapviz - Reporte de Aeropuertos"));
        ...
        boxCategorias.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(Seleccione un Vuelo)" }));
        ...
        lblError.setText("Por favor escoja un Vuelo");
    ...
    private void btnComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprobarActionPerformed
        ...
        if (id != "(Seleccione un Vuelo)") {
            try {
                String nombre = boxCategorias.getSelectedItem().toString();
                String url = "http://127.0.0.1:5000/get_vuelos_aeropuerto/" + nombre;
                String res = crearConexion.crearConexion(url, "HTTP");
                ...
                String url4 = "http://127.0.0.1:5000/dibujar_listaAeropuerto";
    ...
    private void btnExportarPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarPDFActionPerformed
        try {
            ...
            if (control) {
                String id = boxCategorias.getSelectedItem().toString();
                FileOutputStream archivo = new FileOutputStream("D:\\ReporteVuelos.pdf");
                Document documento = new Document();
                PdfWriter.getInstance(documento, archivo);
                PdfPTable table = new PdfPTable(10);

                table.addCell("lugarLlegada");
                table.addCell("aeropuerto");
                table.addCell("horaFechaSalida");

                table.addCell("horaFechaLlegada");
                table.addCell("cantidadPrimeraClase");
                table.addCell("costoPrimeraClase");

                table.addCell("cantidadClaseTurista");

                table.addCell("costoClaseTurista");
                table.addCell("cantidadClaseEjecutiva");
                table.addCell("costoClaseEjecutiva");
                try {
                    String nombre = boxCategorias.getSelectedItem().toString();
                    String url = "http://127.0.0.1:5000/get_vuelos_aeropuertoPDF/" + nombre;
                    String res = crearConexion.crearConexion(url, "HTTP");
                    ...
                    File file = new File("D:\\ReporteVuelos.pdf");
